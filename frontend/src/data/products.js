...
const products = [
  ...
  },
  {
    ...
    description:
      "A fun and colorful graphic T-shirt designed for all-day comfort and playful style. Made from soft, breathable fabric with a cute cartoon print.",
    price: 15.99,
    discountPrice: 12.99,
    countInStock: 50,
    sku: "KIDS-TS-101",
    ...
    colors: ["Sky Blue", "Yellow", "Mint Green"],
    collections: "Everyday Essentials",
    material: "100% Cotton",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=51", altText: "Front view" },
      { url: "https://picsum.photos/500/500?random=52", altText: "Back view" },
    ],
    rating: 4.6,
    numReviews: 23,
  },
  {
    ...
    description:
      "Classic denim shorts with an adjustable waistband. Durable and stylish for summer adventures.",
    price: 22.99,
    discountPrice: 18.99,
    countInStock: 40,
    sku: "KIDS-SH-201",
    ...
    brand: "Mini Denims",
    sizes: ["3T", "4T", "5T", "6Y", "7Y"],
    colors: ["Denim Blue", "Black Wash"],
    collections: "Summer Collection",
    material: "Denim",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=53", altText: "Denim Shorts Front" },
      { url: "https://picsum.photos/500/500?random=54", altText: "Denim Shorts Back" },
    ],
    rating: 4.4,
    numReviews: 18,
  },
  {
    ...
    description:
      "A light, flowy dress with a lovely floral pattern. Perfect for special occasions or weekend outings.",
    price: 29.99,
    discountPrice: 24.49,
    countInStock: 30,
    sku: "KIDS-DR-305",
    ...
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=55", altText: "Floral Dress Front" },
      { url: "https://picsum.photos/500/500?random=56", altText: "Floral Dress Back" },
    ],
    rating: 4.7,
    numReviews: 30,
  },
  {
    name: "Unisex Hoodie for Kids",
    description:
      "Cozy hoodie made from soft fleece, suitable for boys and girls. Features kangaroo pockets and a snug hood.",
    price: 27.99,
    discountPrice: 22.99,
    countInStock: 45,
    sku: "KIDS-HD-402",
    category: "Outerwear",
    brand: "Comfy Kids",
    sizes: ["4T", "5T", "6Y", "7Y", "8Y"],
    colors: ["Red", "Navy", "Grey"],
    collections: "Winter Warmers",
    material: "Fleece",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=57", altText: "Hoodie Front" },
      { url: "https://picsum.photos/500/500?random=58", altText: "Hoodie Back" },
    ],
    rating: 4.5,
    numReviews: 21,
  },
  {
    ...
    description:
      "Soft and breathable pajama set with fun character prints. Ensures a comfortable night's sleep.",
    price: 19.99,
    discountPrice: 15.99,
    countInStock: 60,
    sku: "KIDS-PJ-509",
    ...
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=59", altText: "Pajama Front" },
      { url: "https://picsum.photos/500/500?random=60", altText: "Pajama Back" },
    ],
    rating: 4.8,
    numReviews: 32,
  },
  {
    name: "Kids' Raincoat",
    description:
      "Waterproof raincoat with hood and playful designs. Keeps kids dry and happy during rainy days.",
    price: 24.99,
    discountPrice: 19.99,
    countInStock: 20,
    sku: "KIDS-RC-601",
    ...
    collections: "Rainwear",
    material: "Polyester",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=61", altText: "Raincoat Front" },
      { url: "https://picsum.photos/500/500?random=62", altText: "Raincoat Back" },
    ],
    rating: 4.3,
    numReviews: 12,
  },
  {
    ...
    description:
      "Durable cargo pants with multiple pockets and a relaxed fit. Ideal for active boys on the go.",
    price: 26.99,
    discountPrice: 21.99,
    countInStock: 36,
    sku: "KIDS-CP-702",
    ...
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=63", altText: "Cargo Pants Front" },
      { url: "https://picsum.photos/500/500?random=64", altText: "Cargo Pants Back" },
    ],
    rating: 4.2,
    numReviews: 17,
  },
  {
    ...
    description:
      "Whimsical tutu skirt with layered tulle. Great for dance practice or dress-up play.",
    price: 17.99,
    discountPrice: 14.99,
    countInStock: 25,
    sku: "KIDS-SK-803",
    ...
    collections: "Dress Up",
    material: "Tulle",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=65", altText: "Tutu Skirt Front" },
      { url: "https://picsum.photos/500/500?random=66", altText: "Tutu Skirt Back" },
    ],
    rating: 4.9,
    numReviews: 28,
  },
  {
    name: "Kids' Thermal Set",
    description:
      "Two-piece thermal wear for kids. Soft, stretchy, and warm for chilly winter days.",
    price: 21.99,
    discountPrice: 17.49,
    countInStock: 30,
    sku: "KIDS-TH-904",
    ...
    collections: "Winter Basics",
    material: "Thermal Cotton Blend",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=67", altText: "Thermal Set Front" },
      { url: "https://picsum.photos/500/500?random=68", altText: "Thermal Set Back" },
    ],
    rating: 4.6,
    numReviews: 19,
  },
  {
    name: "Kids' Swimwear Set",
    description:
      "Brightly colored two-piece swimwear for pool and beach fun. Offers UV protection and quick-dry comfort.",
    price: 23.99,
    discountPrice: 19.49,
    countInStock: 22,
    sku: "KIDS-SW-1005",
    category: "Swimwear",
    brand: "Splash Buddies",
    sizes: ["3T", "4T", "5T", "6Y"],
    colors: ["Aqua", "Red", "Yellow"],
    collections: "Swim Fun",
    material: "Nylon-Spandex",
    gender: "Children",
    images: [
      { url: "https://picsum.photos/500/500?random=69", altText: "Swimwear Front" },
      { url: "https://picsum.photos/500/500?random=70", altText: "Swimwear Back" },
    ],
    rating: 4.5,
    numReviews: 25,
  },
